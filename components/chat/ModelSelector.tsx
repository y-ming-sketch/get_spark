...
export function ModelSelector() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 z-20 mt-1.5 w-72 overflow-hidden rounded-xl border border-cream-300 dark:border-ink-500 bg-cream-50 dark:bg-ink-700 shadow-lg animate-fade-in">
          {MODELS.map((m) => (
            <button
              key={m.id}
              onClick={() => {
              ...
              className="flex w-full items-start gap-2 px-3 py-2.5 text-left hover:bg-cream-100 dark:hover:bg-ink-600"
            >
