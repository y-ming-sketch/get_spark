/**
 * Synchronously import every locale bundle so the mobile shell can switch
 * languages without a network round-trip. ~30 KB minified+gzipped — well
 * under the steering performance budget.
 */
